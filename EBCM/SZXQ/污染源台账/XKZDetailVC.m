...
@implementation XKZDetailVC
@synthesize webservice,wrybh,xh;
@synthesize urlStr,fjArray;
...
-(void)processWebData:(NSData*)webData
{
    ...
    NSUInteger  serviceType = TYPE_QUERY_WRY_PWXKZ;
    NSString *htmlStr = [HtmlTableGenerator genContentWithTitle:@"排污许可证详情" andParaMeters:resultDic andType:serviceType];
