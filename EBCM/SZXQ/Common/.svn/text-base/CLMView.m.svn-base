...
- (NSMutableArray *)returnPercentArray
{
    ...
    NSMutableArray *percentAry = [NSMutableArray arrayWithCapacity:20];
    for (NSNumber *tmpNum in valueArr)
    {
        float percent = [tmpNum floatValue] / sum;
        NSString *aStr = [NSString stringWithFormat:@"%.3f",percent];
        percent = [aStr floatValue] * 100 + 0.5;
        
        NSString *percentStr = [NSString stringWithFormat:@"%.1f%%",percent];
        [percentAry addObject:percentStr];
    }
    return percentAry;
}
